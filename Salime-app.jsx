...
function pick(
  ...
  // En modo aleatorio no nos limitamos a los primeros 3 resultados.
  // Geoapify devuelve siempre los resultados en un orden muy parecido y,
  // como todos los lugares mapeados tienen rating 4.2, elegir solo entre
  // los primeros 3 hacía que "Cambiar todo" repitiera siempre los mismos.
  if (random) {
...
async function generatePlan({
  ...
  return steps.map((step) => {
    ...
    const venue = pick(activePool, {
      ...
      exactMinute,
      usedNames,
      // También excluimos los lugares del plan anterior al regenerar.
      // Antes se anulaba esta exclusión cuando random=true, permitiendo
      // que "Cambiar todo" volviera a elegir exactamente los mismos.
      excludeNames,
      allowNightOnly,
      random,
    });
