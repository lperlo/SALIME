...
function pick(
  ...
  if (candidates.length === 0) {
    // En una regeneración/sorpresa no repetimos un lugar ya mostrado.
    // Si no quedan candidatos reales, devolvemos null en vez de reciclarlo.
    if ((excludeNames || []).length > 0) return null;
    candidates = pool;
  }
